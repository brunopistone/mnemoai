...
from personal_ai_assistant.client.ui.chat_interface import ChatInterface
...
def main(verbose: bool = False) -> None:
    ...
    # `python -m personal_ai_assistant.server.server`).
...
def cli() -> None:
    ...
    from personal_ai_assistant.utils.configurator import config_exists, run_first_run_setup

...
import ast
import asyncio
from personal_ai_assistant.client.agent.agent import (
    LangGraphAgent,
    convert_strands_messages_to_langchain,
    convert_langchain_messages_to_strands,
)
from personal_ai_assistant.client.managers.agent_conversation_manager import AgentConversationManager
from personal_ai_assistant.client.managers.user_profile_manager import UserProfileManager
from personal_ai_assistant.client.mcp_tool_wrapper import MCPClientWrapper
from personal_ai_assistant.client.memory.episodic_memory import EpisodicMemoryManager
from personal_ai_assistant.client.memory.reflector import Reflector
from personal_ai_assistant.client.memory.playbook_store import PlaybookStore
from personal_ai_assistant.client.agent.router import QueryRouter, ROUTE_TOOLS
from personal_ai_assistant.client.ui.spinner import Spinner
from datetime import date, datetime
import json
from langchain_core.callbacks import BaseCallbackHandler
from mcp import StdioServerParameters
from personal_ai_assistant.models.controllers.llm_controller import LangChainLLMController
import numpy as np
import os
import re
from personal_ai_assistant.server.tools import count_tokens
from personal_ai_assistant.utils.paths import model_dir, profile_dir, sanitize_model_name
import shutil
import sqlite3
import sys
import threading
...
class LangGraphClient:
    ...
    def __init__(
        ...
        # (`python -m personal_ai_assistant.server.server`). Ensure the child
        ...
        # parent dir to PYTHONPATH. `import personal_ai_assistant` resolves to
        # .../personal_ai_assistant/__init__.py, so two dirnames up is the dir
        # that must be importable.
        import personal_ai_assistant

        pkg_parent = os.path.dirname(
            os.path.dirname(os.path.abspath(personal_ai_assistant.__file__))
        )
        env = os.environ.copy()
        ...
        self.server_params = StdioServerParameters(
            ...
            args=["-m", "personal_ai_assistant.server.server"],
            env=env,
        )
    ...
    def _initialize_episodic_memory(self) -> None:
        ...
        from personal_ai_assistant.models.controllers.embeddings_controller import EmbeddingsController
    ...
    def _flush_chunk_cache_store(self) -> None:
        ...
        try:
            from personal_ai_assistant.server.tools.readers.chunking_helper import reset_session_chunk_cache
    ...
    def _flush_rag_store(self) -> None:
        ...
        try:
            from personal_ai_assistant.server.tools.rag import reset_session_rag
